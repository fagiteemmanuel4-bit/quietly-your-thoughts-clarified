...
export const Route = createFileRoute("/cookies")({
  head: () => ({ meta: [{ title: "Cookie Policy — Quietly" }, { name: "description", content: "How Quietly uses cookies and similar technologies." }] }),
  component: Cookies,
});
  ...
  return (
    <LegalLayout title="Cookie Policy" updated="June 9, 2026">
      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li><strong>Analytics cookies</strong> — help us understand usage in aggregate. You can opt out.</li>
      </ul>

      <h2 className="font-display text-2xl mt-10">3. Third-party cookies</h2>
      <p>
        Our authentication providers (e.g. Google) and analytics tools may set their own cookies under
        their respective privacy policies.
      </p>

      <h2 className="font-display text-2xl mt-10">4. Managing cookies</h2>
      <p>
        You can manage cookies via your browser settings. Disabling essential cookies may impair core
        Service functionality.
      </p>

      <h2 className="font-display text-2xl mt-10">5. Contact</h2>
      <p>Questions? Email <a href="mailto:privacy@quietly.app" className="underline">privacy@quietly.app</a>.</p>
    </LegalLayout>
  );
}
